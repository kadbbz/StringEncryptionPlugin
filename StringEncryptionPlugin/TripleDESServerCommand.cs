...
namespace StringEncryptionPlugin
{
    ...
    [Category("字符串加解密")]
    [OrderWeight(101)]
    public class TripleDESServerCommand : BaseEncryptServerCommand, ICommandExecutableInServerSideAsync
    {
        [ComboProperty]
        [DisplayName("操作方向")]
        [OrderWeight(1)]
        ...
        [FormulaProperty]
        [DisplayName("密钥（Key）")]
        [Description("长度为24个字符，只能使用英文字母和数字")]
        [OrderWeight(101)]
        ...
        public async Task<ExecuteResult> ExecuteAsync(IServerCommandExecuteContext dataContext)
        {
            ...
            byte[] byKey = System.Text.ASCIIEncoding.ASCII.GetBytes(regularKeyString(key, 24));
        ...
        public override string ToString()
        {
            ...
            {
                return "TripleDES" + ((Operation == OperationEnum.Encrypt) ? "加" : "解") + "密：" + ResultTo;
            }
        }
